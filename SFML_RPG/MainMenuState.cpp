...
void MainMenuState::initGui()
{
	...
	this->buttons["PLAYERSELECT_STATE"] = new gui::Button(
		gui::p2pX(15.6f, vm), gui::p2pY(30.f, vm),
		gui::p2pX(13.f, vm), gui::p2pY(6.f, vm),
		&this->font, "Player Select", gui::calcCharSize(vm),
		sf::Color(200, 200, 200, 200), sf::Color(255, 255, 255, 255), sf::Color(20, 20, 20, 50),
		sf::Color(70, 70, 70, 0), sf::Color(150, 150, 150, 0), sf::Color(20, 20, 20, 0)
	);
...
void MainMenuState::updateButtons()
{
	...
	//New game
	if (this->buttons["PLAYERSELECT_STATE"]->isPressed())
	{
		this->states->push(new PlayerSelectState(this->stateData));
	}
