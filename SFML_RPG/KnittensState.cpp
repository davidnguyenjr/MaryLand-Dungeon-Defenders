...
void KnittensState::initDeferredRender()
{
...
void KnittensState::initKeybinds()
{
...
void KnittensState::initTextures()
{
	if (!this->textures["PLAYER_SHEET"].loadFromFile("Resources/Images/Sprites/Player/KNITTENS_SHEET.png"))
	{
...
void KnittensState::initPauseMenu()
{
...
void KnittensState::initShaders()
{
...
void KnittensState::initKeyTime()
{
	this->keyTimeMax = 0.3f;
	this->keyTimer.restart();
}

void KnittensState::initDebugText()
{
...
const bool KnittensState::getKeyTime()
{
...
//Functions
void KnittensState::updateView(const float& dt)
{
	this->view.setCenter(
...
void KnittensState::updateInput(const float& dt)
{
...
void KnittensState::updatePlayerInput(const float& dt)
{
	//Update player input
...
void KnittensState::updatePlayerGUI(const float& dt)
{
...
void KnittensState::updatePauseMenuButtons()
{
...
void KnittensState::updateTileMap(const float& dt)
{
...
void KnittensState::updatePlayer(const float& dt)
{
	this->player->update(dt, this->mousePosView, this->view);
}

void KnittensState::updateCombatAndEnemies(const float& dt)
{
...
void KnittensState::updateCombat(Enemy* enemy, const int index, const float& dt)
{
...
void KnittensState::updateDebugText(const float& dt)
{
	std::stringstream ss;
...
void KnittensState::update(const float& dt)
{
...
void KnittensState::render(sf::RenderTarget* target)
{
	if (!target)
		target = this->window;
