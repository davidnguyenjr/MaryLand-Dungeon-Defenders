...
void MaryState::initDeferredRender()
{
...
void MaryState::initKeyTime()
{
	this->keyTimeMax = 0.3f;
	this->keyTimer.restart();
}

void MaryState::initDebugText()
{
...
const bool MaryState::getKeyTime()
{	
...
//Functions
void MaryState::updateView(const float & dt)
{
	this->view.setCenter(
...
void MaryState::updateInput(const float & dt)
{
...
void MaryState::updatePlayerInput(const float & dt)
{
	//Update player input
...
void MaryState::updatePlayerGUI(const float & dt)
{
...
void MaryState::updatePauseMenuButtons()
{
...
void MaryState::updateTileMap(const float & dt)
{
...
void MaryState::updatePlayer(const float & dt)
{
	this->player->update(dt, this->mousePosView, this->view);
}

void MaryState::updateCombatAndEnemies(const float & dt)
{
...
void MaryState::updateCombat(Enemy* enemy, const int index, const float & dt)
{
...
void MaryState::updateDebugText(const float& dt)
{
	std::stringstream ss;
...
void MaryState::update(const float& dt)
{
...
void MaryState::render(sf::RenderTarget* target)
{
	if (!target)
		target = this->window;
